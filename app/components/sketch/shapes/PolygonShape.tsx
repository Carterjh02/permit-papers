 ...
 *
 * Responsibilities:
 * - Render an N‑point polygon using a closed Konva Line.
 ...
 * - Prepare for future dragging / bounding box / vertex editing.
 */
export default function PolygonShape({ shape }: PolygonShapeProps) {
